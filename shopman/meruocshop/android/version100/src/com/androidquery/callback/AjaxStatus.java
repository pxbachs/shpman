...
public class AjaxStatus {
	...
	/**
	 * Close any opened inputstream associated with the response. Call this
	 * method when finish parsing the response of a synchronous call.
	 * 
	 */
	...
	/**
	 * Gets the object fetched time. Returns original fetch time when url is
	 * file cached.
	 * 
	...
	/**
	 * Gets the http client used to fetch the url. User can access other
	 * resources like response headers and cookies. Returns null if object is
	 * cached (source is not AjaxStatus.NETWORK).
	 * 
	 * @return http client
	 */
	...
	/**
	 * Gets the source type. Can be AjaxStatus.NETWORK, AjaxStatus.DATASTORE,
	 * AjaxStatus.FILE, or AjaxStatus.MEMORY.
	 * 
	 * @return source
	 */
	...
	/**
	 * Gets the error response as a string. For http response code that's not
	 * 200-299.
	 * 
	 * @return source
	 */
	...
	/**
	 * Test if the response is expired against current time, given the expire
	 * duration in milliseconds. If the ajax source is NETWORK, it's never
	 * considered expired.
	 * 
	 ...
	 * 
	 * Return values only when source is not from cache (source == NETWORK),
